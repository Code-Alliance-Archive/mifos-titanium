 ...
 * Copyright (c) 2009-2011 by mifos, Inc. All Rights Reserved.
...
//@interface mifosObject : NSObject
//@end

@interface mifosObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[mifosObject class]])
		{
			for (NSString *key in [[(mifosObject*)o modules] allKeys])
			{
